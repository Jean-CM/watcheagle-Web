        ...
        <form method="GET" action="/seed-batch">
            <div class="grid-2" style="margin-bottom:12px;">
                <div class="field">
                    ...
                    <input type="text" name="prefix" placeholder="Ej: Box-01" required>
                </div>
                <div class="field">
                    <label>App</label>
                    <select name="app" required>
            ...
            <div class="field" style="margin-bottom:12px;">
                ...
                <textarea name="users" placeholder="equipoC01,equipoC02,equipoC03" required></textarea>
            </div>

            <button class="btn-primary" type="submit">Cargar varios equipos</button>
            <div class="form-note">
                Puedes cargar 10, 20 o más equipos de una vez, separados por coma.
            </div>
        </form>
    </div>
    """
